    ...
    >
      <div className="container px-5 md:px-16 flex items-center justify-between mx-auto">
          ...
          >
            ...
            {["home", "features","pricing"].map((link) => (
              <li
                key={link}
                className={`${
                  selectedItem === link ? "text-teal-600" : ""
                } capitalize border-b py-4 md:border-none md:py-0 hover:text-teal-600`}
            ...
            <div className="md:hidden mx-auto absolute bottom-16 left-1/2 -translate-x-1/2 flex gap-3">
              <Link href="#">
                <FacebookOutlinedIcon className="cursor-pointer hover:text-teal-600 text-xl" />
              </Link>
              <Link href="#">
                <LinkedInIcon className="cursor-pointer hover:text-teal-600 text-xl" />
              </Link>
              <Link href="#">
                <GitHubIcon className="cursor-pointer hover:text-teal-600 text-xl" />
              </Link>
              <Link href="#">
                <InstagramIcon className="cursor-pointer hover:text-teal-600 text-xl" />
              </Link>
            </div>
          </ul>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4 md:gap-2 lg:gap-4">
          <button className="capitalize text-sm sm:text-base border-2 hover:border-2 font-semibold sm:py-3 py-2 px-3 sm:px-6 text-teal-600 border-teal-600 hover:border-teal-600 hover:bg-teal-600 hover:text-white rounded-full">
...
export default PitchPortalNavbar;
